...
@section('content')
    <div class="container-fluid col-11 rounded" style="background-color: rgb(255, 255, 255)">
        <form action="{{ route('cliente.store') }}" method="post" class="formulario">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-8 form-group">
                        <label for="name">Nombres</label>
                        <input  type="text" class="form-control" id="exampleInputEmail1" placeholder="Ingresar nombres" name="nombre" value="{{ old('nombre') }}">
                        @error('nombre')
                      ...
                      <div class="col-4 form-group" >
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <input  type="radio" id="rb_natural" name="tipoCliente" value="NATURAL" {{ (old('tipoCliente') == "NATURAL") ? "checked" : "" }}>
                                </div>
                                ...
                                <div class="col-2">
                                    <input  type="radio" id="rb_juridico" name="tipoCliente" value="JURIDICO" {{ (old('tipoCliente') == "JURIDICO") ? "checked" : "" }}>
                                </div>
                ...
                <div class="row">
                    <div class="col-6 form-group">
                        ...
                        <input  type="text" class="form-control" id="exampleInputEmail1" placeholder="Ingrese Nro documento" name="nroDocumento" value="{{ old('nroDocumento') }}">
                        @error('nroDocumento')
                            <span class="text-danger">* {{ $message }}</span>
                        @enderror 
                    </div>
...
@section('js')
    ...
    <script>
        ...
        $('.formulario').submit(function (e) {
            e.preventDefault()
            Swal.fire({
                title: '¿Confirme para guardar datos?',
                icon: 'warning',
